...
import { UNDATED_KEY, formatCaptured } from '../meta/datetime';
...
function chipParts(day: DayGroup): { month: string; number: string; weekday: string } {
